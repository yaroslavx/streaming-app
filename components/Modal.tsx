    ...
    return (
        <MuiModal open={showModal} onClose={handleClose} className="fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide">
            <>
                ...
                <button onClick={handleClose} className='modalButton absolute top-5 right-5 h-9 w-9 bg-[#181818] border-none !z-40 '>
                ...
                <div className="flex space-y-16 rounded-b-md bg-[#181818] px-10 py-8">
                    <div className="space-y-3 text-lg">
                        <div className="flex items-center space-x-2 text-sm">
                            <p className="font-semibold text-green-400">{movie!.vote_average}% Match </p>
